class Locators():
    ...
    cart_product_names_xpath = "(//div[@class='MuiCardHeader-content mui-1aan0jy']//span)[1]"
    cart_product_prices_xpath = "//div[@class='MuiBox-root mui-jysr79']/following-sibling::p[1]"
